...
void aug()
{
    ...
    while (1)
    {
        ...
        //printf("%d ",num);
        for (i=1; i<=num; i++)  //note that the total time is O(m), because each node can be visited once
